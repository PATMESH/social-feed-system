package com.dev.graphservice.kafka.producer;
        ...
        kafkaTemplate.send(record)
                .whenComplete((result, ex) -> {
                    if (ex == null) {
                        ...
                        log.info(
                                "Event published successfully - Topic: {}, Partition: {}, Offset: {}, CorrelationId: {}",
                                metadata.topic(),
                                metadata.partition(),
                                metadata.offset(),
                                correlationId
                        ...
                        log.error(
                                "Failed to publish event - Topic: {}, Type: {}, Key: {}, CorrelationId: {}",
